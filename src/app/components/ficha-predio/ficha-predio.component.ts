      ...
      content: [
        {
          ...
          table: {
            ...
            margin: [0, 20, 0, 8],
            body: [
              [{text: 'CHIP:'+this.predio.GN_CHIP, colSpan: 2, style: 'tableHeader', fillColor: '#CCC'}, {}, {text: 'FECHA: I-2023*', style: 'tableHeader', fillColor: '#CCC'}],
            ]
          }
        },
        {
          ...
          table: {
            ...
            margin: [0, 20, 0, 8],
            body: [
              [{text: 'UPL: ', style: 'subheader', fillColor: '#CCC'}, {text: 'Area del proy: XXXX', style: 'subheader', fillColor: '#CCC'}, {text: 'FICHA No. XXX*', style: 'subheader', fillColor: '#CCC'}]
            ]
          }
        },
        {
        ...
        },
        {
          ...
          table: {
            widths: [340, 180],
            body: [
              [{colSpan:2, text: 'Información Urbanística', style: 'header', fillColor: '#CCC'}, {}],
              [{text: 'ÁREA BRUTA (M2)', style: 'subheader', fillColor: '#CCC'}, {text: '228072.17'}],
              [{text: 'ÁREA NO URBANIZABLE-RESERVAS (M2)', style: 'subheader', fillColor: '#CCC'}, {text: '6802.72'}],
              [{text: 'ÁREA NETA TODAS LAS ETAPAS LICENCIADAS (M2)', style: 'subheader', fillColor: '#CCC'}, {text: '433,794.65'}],
              [{text: 'CESIONES DE MALLA VIAL (Contro Ambiental y vias) (M2)', style: 'subheader', fillColor: '#CCC'}, {text: '41,023.55'}],
