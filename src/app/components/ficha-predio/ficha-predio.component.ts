...
export class FichaPredioComponent implements OnInit   {
  ...
  async ngOnInit(): Promise<any> {
    ...
    this.mapUrl+=`${environment.urlExportMap}bbox=${xmin},${ymin},${xmax},${ymax}&layers=show%3A4&layerDefs=%7B%224%22%3A%22GN_CODIGO_LOTE+%3D+%27${this.predio.GN_CODIGO_LOTE}%27%22%7D&size=510%2C280&format=png&transparent=true&mapScale=4000&f=image`;
