...
export class FichaProyectoComponent implements OnInit   {
  ...
  private mapUrl= "";
  private baseMapUrl= "";
  private planoteca:any;
  private extentPlanoteca:any;
  private planotecaUrl: any;
  ...
  async ngOnInit(): Promise<any> {
    ...
    this.proyecto = await this.mapService.consultarProyecto(this.idProyecto);
    ...
    this.lote = await this.mapService.consultarLoteById(this.fichaData.CODIGO_LOTE);

    this.planoteca = await this.mapService.consultarPlanoteca (this.proyecto.LONGITUD, this.proyecto.LATITUD);
    
    console.log("planoteca", this.planoteca);

    this.extentPlanoteca = await this.mapService.consultarExtentPlanoteca (this.planoteca.LLAVE_PLANO);

    console.log("extentPlanoteca", this.extentPlanoteca);

    this.planotecaUrl = await this.mapService.consultarImagenPlanoteca(this.extentPlanoteca, this.planoteca.LLAVE_PLANO);

    console.log("planotecaUrl", this.planotecaUrl.data.href);
  ...
  public export(): void {
    ...
    const docDefinition: any = {
      ...
      images: {
        ...
        planotecaMap: this.planotecaUrl.data.href,
