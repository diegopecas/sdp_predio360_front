            ...
            },
            {
              ...
              table: {
                ...
                body: [
                  ...
                  [{rowSpan: 2, text: 'DIRECCIÓN', style: 'subheader'}, {rowSpan: 2, text: 'Norte: Canal Castiall'},{text: 'ESTADO:', style: 'subheader'}, {text: 'Construido'}],
                  [{text: 'CHIP:', style: 'subheader'}, {text: 'AAA0137ZEBR'},{text: 'MATRÍCULA INMOBILIARIA:', style: 'subheader'}, {text: '2'}],
                  [{}, {},{text: 'ESTRATO::', style: 'subheader'}, {text: '50C-260832'}]
                ]
              },
            }
